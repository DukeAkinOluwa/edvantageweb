                ...
                <div className="space-y-16">
                  <section className="bgwhite rounded-2xl shadow-md overflow-hidden p-8 md:p-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                      <div className="bgwhite rounded-lg shadow-md p-6 transform hover:scale-105 transition-transform duration-300 border border-edvantae-light-blue">
                        <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-edvantae-light-blue flex items-center justify-center">
                          <Target className="h-8 w-8 text-edvantae-blue" />
                        </div>
                        <h3 className="text-xl font-semibold mb-3 text-center text-edvantae-dark-blue">Enhance Productivity</h3>
                        <p className="text-gray-700 text-center">Help students master time management and stay focused on their academic goals.</p>
                      </div>
                      
                      <div className="bgwhite rounded-lg shadow-md p-6 transform hover:scale-105 transition-transform duration-300 border border-edvantae-light-blue">
                        <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-edvantae-light-blue flex items-center justify-center">
                          <Lightbulb className="h-8 w-8 text-edvantae-blue" />
                        </div>
                        <h3 className="text-xl font-semibold mb-3 text-center text-edvantae-dark-blue">Support Achievement</h3>
                        <p className="text-gray-700 text-center">Provide integrated tools for scheduling, task management, and timely reminders.</p>
                      </div>
                      
                      <div className="bgwhite rounded-lg shadow-md p-6 transform hover:scale-105 transition-transform duration-300 border border-edvantae-light-blue">
                        <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-edvantae-light-blue flex items-center justify-center">
                          <Users className="h-8 w-8 text-edvantae-blue" />
                        </div>
                        <h3 className="text-xl font-semibold mb-3 text-center text-edvantae-dark-blue">Foster Collaboration</h3>
                        <p className="text-gray-700 text-center">Enable real-time sharing of study materials, schedules, and academic resources.</p>
                      </div>
                      
                      <div className="bgwhite rounded-lg shadow-md p-6 transform hover:scale-105 transition-transform duration-300 border border-edvantae-light-blue">
                        <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-edvantae-light-blue flex items-center justify-center">
                          <Rocket className="h-8 w-8 text-edvantae-blue" />
                        </div>
                        <h3 className="text-xl font-semibold mb-3 text-center text-edvantae-dark-blue">Drive Motivation</h3>
                  ...
                  <section className="bgwhite rounded-2xl shadow-sm overflow-hidden">
                    <div className="grid md:grid-cols-2">
                      <div className="p-8">
                        <h2 className="text-2xl font-semibold mb-4 text-edvantae-blue">Our Purpose</h2>
                        <p className="text-lg leading-relaxed text-gray-700">
                          Edvantae simplifies the academic journey for tertiary students by providing an engaging and efficient 
                        ...
                        <div className="mt-4 space-y-3">
                          <div className="flex items-start">
                            <div className="flex-shrink-0 h-6 w-6 bg-edvantae-light-blue rounded-full flex items-center justify-center mt-1">
                              <span className="text-edvantae-blue text-sm">1</span>
                            </div>
                            <p className="ml-3 text-gray-700">Overcoming poor time management through structured scheduling</p>
                          </div>
                          <div className="flex items-start">
                            <div className="flex-shrink-0 h-6 w-6 bg-edvantae-light-blue rounded-full flex items-center justify-center mt-1">
                              <span className="text-edvantae-blue text-sm">2</span>
                            </div>
                            <p className="ml-3 text-gray-700">Replacing disjointed academic planning with centralized tools</p>
                          </div>
                          <div className="flex items-start">
                            <div className="flex-shrink-0 h-6 w-6 bg-edvantae-light-blue rounded-full flex items-center justify-center mt-1">
                              <span className="text-edvantae-blue text-sm">3</span>
                            </div>
                            <p className="ml-3 text-gray-700">Creating a hub for student collaboration and resource sharing</p>
                          </div>
                        </div>
                        <Link href="/contact" className="inline-flex items-center text-edvantae-blue font-medium mt-6 hover:underline">
                          Learn how we can help you
                          <ArrowRight size={16} className="ml-1" />
                        </Link>
                      </div>
                      <div className="bg-edvantae-light-blue/30 max-h-96 overflow-hidden">
                        <Image 
                  ...
                  <section className="bgwhite rounded-2xl shadow-sm overflow-hidden">
                    <div className="grid md:grid-cols-2">
                      <div className="bg-edvantae-light-blue/30 max-h-96 overflow-hidden order-2 md:order-1">
                        <Image 
                      ...
                      <div className="p-8 order-1 md:order-2">
                        <h2 className="text-2xl font-semibold mb-4 text-edvantae-blue">Our Brand Story</h2>
                        ...
                        <div className="bg-edvantae-light-blue/20 p-4 rounded-lg italic text-gray-700 border-l-4 border-edvantae-blue">
                          &quot;We created Edvantae because we believe every student deserves tools that work as hard as they do.&quot;
                        </div>
                        <Link href="/leadership" className="inline-flex items-center text-edvantae-blue font-medium mt-6 hover:underline">
                  ...
                  <section className="bg-gray-50 p-10 rounded-3xl shadow-inner">
                    <h2 className="text-2xl font-semibold mb-8 text-center text-edvantae-blue">Our Values</h2>
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                      <div className="p-6 bgwhite rounded-lg shadow-md transform hover:scale-105 transition-transform duration-300">
                        <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-edvantae-light-blue flex items-center justify-center">
                          <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-edvantae-blue" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                          </svg>
                        </div>
                        <h3 className="text-xl font-semibold mb-2 text-center text-edvantae-blue">Efficiency</h3>
                      ...
                      <div className="p-6 bgwhite rounded-lg shadow-md transform hover:scale-105 transition-transform duration-300">
                        ...
                        <h3 className="text-xl font-semibold mb-2 text-center text-edvantae-blue">Community</h3>
                      ...
                      <div className="p-6 bgwhite rounded-lg shadow-md transform hover:scale-105 transition-transform duration-300">
                        ...
                        <h3 className="text-xl font-semibold mb-2 text-center text-edvantae-blue">Integrity</h3>
                      ...
                      <div className="p-6 bgwhite rounded-lg shadow-md transform hover:scale-105 transition-transform duration-300">
                        ...
                        <h3 className="text-xl font-semibold mb-2 text-center text-edvantae-blue">Reliability</h3>
