  ...
  function Index () {
    ...
    const faqs = [
      ...
      },
      {
        ...
        answer: "Edvantage offers a freemium model. Basic features are available for free, with premium features accessible for ₦00.00/year - an affordable price designed specifically for students."
      },
      {
